...
const handleSubmit = async(e) => {
    try {
        ...
        await fetch("https://getform.io/f/cf494065-8ed1-45be-8dc6-c29364a7c47e", {
            method: "POST",
            body: formData
        })
    ...
    <div name="contact" className='min-h-screen w-full h-max bg-gradient-to-b from-black to-gray-800 p-4 text-white'>
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            ...
            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/cf494065-8ed1-45be-8dc6-c29364a7c47e" method='POST' ref={formRef} onSubmit={handleSubmit} className='flex flex-col w-full md:w-1/2'>
